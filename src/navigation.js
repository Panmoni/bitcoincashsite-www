...
export const footerData = {
  ...
  socialLinks: [
    { ariaLabel: 'X', icon: 'cib:twitter', href: 'https://twitter.com/bitcoincashsite' },
    { ariaLabel: 'Telegram', icon: 'cib:telegram', href: 'https://t.me/bitcoincashsite' },
    { ariaLabel: 'YouTube', icon: 'cib:youtube', href: 'https://youtube.com/@RealBitcoinCashSite' },
    { ariaLabel: 'Reddit', icon: 'cib:reddit', href: 'https://www.reddit.com/r/BCHCashTokens/' },
    { ariaLabel: 'Instagram', icon: 'cib:instagram', href: 'https://instagram.com/bitcoincashsite' },
    { ariaLabel: 'LinkedIn', icon: 'cib:linkedin', href: 'https://www.linkedin.com/company/bitcoincashsite/' },
    { ariaLabel: 'Facebook', icon: 'cib:facebook', href: 'https://facebook.com/bitcoincashsite' },
    { ariaLabel: 'Github', icon: 'cib:github', href: 'https://github.com/Panmoni/bitcoincashsite-www' },
    { ariaLabel: 'RSS', icon: 'cib:rss', href: getAsset('/rss.xml') },
  ],
  footNote: `
